      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-8">
          <div className="space-y-4">
            <Badge
              variant="secondary"
              className="w-fit mx-auto bg-white/20 text-white border-white/30"
            >
            ...
            <p className="text-lg text-primary-foreground/80 max-w-2xl mx-auto">
              ...
              Stacks' AI-powered coaching and blockchain-secured transparency.
            </p>
          </div>
          ...
          <div className="pt-8 border-t border-white/20">
            <p className="text-lg text-primary-foreground/80">
              <span className="text-accent">Stacks:</span> Making finance
              transparent, personal, and rewarding.
              <br />
