  ...
  const features = [
    {
      ...
      description:
        'Get personalized budgets, investment strategies, and financial education through conversational AI guidance.',
      badge: 'AI Powered',
    ...
    },
    {
      ...
      description:
        'Smart contracts enforce savings goals while providing immutable records of all recommendations and transactions.',
      badge: 'Blockchain',
    ...
    },
    {
      ...
      description:
        'Earn tokens for achieving financial milestones and redeem them for discounts, cashback, or staking opportunities.',
      badge: 'Gamified',
    ...
    },
    {
      ...
      description:
        'Access fractionalized, blockchain-secured investments that make wealth-building inclusive and beginner-friendly.',
      badge: 'Investing',
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-foreground-subtle max-w-3xl mx-auto">
            Stacks combines cutting-edge AI with blockchain technology to
            deliver a comprehensive financial education and wealth-building
            platform.
          </p>
        </div>
            ...
            >
              <CardHeader>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge variant="glass">{feature.badge}</Badge>
                </div>
                <CardTitle className="text-xl">{feature.title}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-foreground-subtle">{feature.description}</p>
